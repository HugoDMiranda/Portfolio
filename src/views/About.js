      ...
      <main className="con">
        <div className="about">
          ...
          <div className="me">
            <h3>About Me</h3>
            <p>
              My name is Hugo Miranda and I`m a passionate
              <strong> Full Stack Developer</strong> using web technologies to
              build amazing projects and focusing on solving problems from
              different aspects of programming using the power of technology.
            </p>
